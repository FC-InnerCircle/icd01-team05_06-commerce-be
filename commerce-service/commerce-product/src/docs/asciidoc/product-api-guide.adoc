...
== 주문 전 상품 조회
=== Http
include::{snippets}/api/v1/products/order/before/http-request.adoc[]
=== Request
include::{snippets}/api/v1/products/order/before/request-fields.adoc[]
=== Response
include::{snippets}/api/v1/products/order/before/response-fields.adoc[]
include::{snippets}/api/v1/products/order/before/response-body.adoc[]
