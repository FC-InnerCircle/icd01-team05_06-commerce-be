...
== 사용자별 상품 리뷰 조회
=== Http
include::{snippets}/reviews/v1/reviews/member/http-request.adoc[]
=== Request
include::{snippets}/reviews/v1/reviews/member/path-parameters.adoc[]
=== Response
include::{snippets}/reviews/v1/reviews/member/response-fields.adoc[]
include::{snippets}/reviews/v1/reviews/member/response-body.adoc[]
