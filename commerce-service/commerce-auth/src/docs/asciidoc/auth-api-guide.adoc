...
== 비밀번호 확인
=== Http
include::{snippets}/auth/v1/password-verify/http-request.adoc[]
=== Request
include::{snippets}/auth/v1/password-verify/request-fields.adoc[]
=== Response
include::{snippets}/auth/v1/password-verify/response-fields.adoc[]
include::{snippets}/auth/v1/password-verify/response-body.adoc[]
